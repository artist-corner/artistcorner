								...
								<div class="inner">
									...
									<section class="features">
										<article>
											...
											echo "<a href='perfil/perfil.php?art=$artistalike[id_Usuario]' class='special'>Ver más</a>";
											?>
										</article>
										<article>
											<?php
								...
								<div class="inner">
									...
									<div class="content">
										...
										while ($musiclike = mysqli_fetch_array($sqlmusic_like)) {
											...
											echo "<a href='obra.php?art=$musiclike[id_Usuario]&arc=$musiclike[id_Obra]'><img src='usuarios/$musiclike[usuario]/obras/$musiclike[portada]' width='150' height='100'/></a>&nbsp";
											// echo "$musiclike[usuario] - $musiclike[portada]<br>";
											}else{
												echo "<a href='obra.php?art=$musiclike[id_Usuario]&arc=$musiclike[id_Obra]'><img src='img/sinPortada.jpg' width='150' height='100'/></a>&nbsp";
											}
										}
										...
										?>
										<a href="mostrarmusica.php" class="special">Ver más</a>
										...
										while ($musiclike2 = mysqli_fetch_array($sqlmusic_like2)) {
											...
											echo "<a href='obra.php?art=$musiclike2[id_Usuario]&arc=$musiclike2[id_Obra]'><img src='usuarios/$musiclike2[usuario]/obras/$musiclike2[portada]' width='150' height='100'/></a>&nbsp";
											// echo "$musiclike[usuario] - $musiclike[portada]<br>";
											}else{
												echo "<a href='obra.php?art=$musiclike2[id_Usuario]&arc=$musiclike2[id_Obra]'><img src='img/sinPortada.jpg' width='150' height='100'/></a>&nbsp";
											}
										}
								...
								<div class="inner">
									...
									<div class="content">
										...
										while ($pinturalike = mysqli_fetch_array($sqlpintura_like)) {
											echo "<a href='obra.php?art=$pinturalike[id_Usuario]&arc=$pinturalike[id_Obra]'><img src='usuarios/$pinturalike[usuario]/obras/$pinturalike[archivo]' width='150' height='100'/></a>&nbsp";
											// echo "$musiclike[usuario] - $musiclike[portada]<br>";
										}
										...
										<!-- <img src="images/pic01.jpg" width="150px" height="100px">&nbsp<img src="images/pic01.jpg" width="150px" height="100px">&nbsp<img src="images/pic01.jpg" width="150px" height="100px">&nbsp<img src="images/pic01.jpg" width="150px" height="100px">
										 -->
										<a href="mostrarimagenes.php" class="special">Ver más</a>
										<h2 class="major">Últimas obras</h2>
										<?php
										...
										while ($pinturalike2 = mysqli_fetch_array($sqlpintura_like2)) {
											echo "<a href='obra.php?art=$pinturalike2[id_Usuario]&arc=$pinturalike2[id_Obra]'><img src='usuarios/$pinturalike2[usuario]/obras/$pinturalike2[archivo]' width='150' height='100'/></a>&nbsp";
											// echo "$musiclike[usuario] - $musiclike[portada]<br>";
										}
								...
								<div class="inner">
									...
									<div class="content">
										...
										while ($literaturalike = mysqli_fetch_array($sqlliteratura_like)) {
											...
											echo "<a href='obra.php?art=$literaturalike[id_Usuario]&arc=$literaturalike[id_Obra]'><img src='usuarios/$literaturalike[usuario]/obras/$literaturalike[portada]' width='150' height='100'/></a>&nbsp";
											// echo "$musiclike[usuario] - $musiclike[portada]<br>";
											}else{
												echo "<a href='obra.php?art=$literaturalike[id_Usuario]&arc=$literaturalike[id_Obra]'><img src='img/sinPortada.jpg' width='150' height='100'/></a>&nbsp";
											}
										}
										...
										?>
										<!-- <img src="images/pic01.jpg" width="150px" height="100px">&nbsp<img src="images/pic01.jpg" width="150px" height="100px">&nbsp<img src="images/pic01.jpg" width="150px" height="100px">&nbsp<img src="images/pic01.jpg" width="150px" height="100px"> -->
										<a href="mostrarliteratura.php" class="special">Ver más</a>
										<h2 class="major">Últimas obras</h2>
										<?php
										...
										while ($literaturalike2 = mysqli_fetch_array($sqlliteratura_like2)) {
											...
											echo "<a href='obra.php?art=$literaturalike2[id_Usuario]&arc=$literaturalike2[id_Obra]'><img src='usuarios/$literaturalike2[usuario]/obras/$literaturalike2[portada]' width='150' height='100'/></a>&nbsp";
											// echo "$musiclike[usuario] - $musiclike[portada]<br>";
											}else{
												echo "<a href='obra.php?art=$literaturalike2[id_Usuario]&arc=$literaturalike2[id_Obra]'><img src='img/sinPortada.jpg' width='150' height='100'/></a>&nbsp";
											}
										}
								...
								<div class="inner">
									...
									<div class="content">
										...
										while ($videolike = mysqli_fetch_array($sqlvideo_like)) {
											echo "<a href='obra.php?art=$videolike[id_Usuario]&arc=$videolike[id_Obra]'><img src='usuarios/$videolike[usuario]/obras/$videolike[portada]' width='150' height='100'/></a>&nbsp";
											// echo "$musiclike[usuario] - $musiclike[portada]<br>";
										}
...
<!-- 										<img src="images/pic01.jpg" width="150px" height="100px">&nbsp<img src="images/pic01.jpg" width="150px" height="100px">&nbsp<img src="images/pic01.jpg" width="150px" height="100px">&nbsp<img src="images/pic01.jpg" width="150px" height="100px">
 -->										<a href="mostrarvideo.php" class="special">Ver más</a>
										<h2 class="major">Últimas obras</h2>
										<?php
										...
										while ($videolike2 = mysqli_fetch_array($sqlvideo_like2)) {
											echo "<a href='obra.php?art=$videolike2[id_Usuario]&arc=$videolike2[id_Obra]'><img src='usuarios/$videolike2[usuario]/obras/$videolike2[portada]' width='150' height='100'/></a>&nbsp";
											// echo "$musiclike[usuario] - $musiclike[portada]<br>";
										}
